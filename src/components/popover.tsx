...
const popoverStyles = tv({
    base: [
        `rounded border border-gray-200 text-primary shadow-2xl transition-none
        forced-colors:bg-[Canvas]`,
    ],
    extend: bgGlass,
    variants: {
        isEntering: {
            true: `ease-out animate-in fade-in placement-left:slide-in-from-right-1
            placement-right:slide-in-from-left-1 placement-top:slide-in-from-bottom-1
            placement-bottom:slide-in-from-top-1`,
        },
        isExiting: {
            true: `duration-150 ease-in animate-out fade-out placement-left:slide-out-to-right-1
        ...
        >
            {(showArrow ?? false) && (
                <OverlayArrow className="group">
                    <svg
                        className="block fill-[theme(backgroundColor.base)] stroke-gray-200 stroke-1
