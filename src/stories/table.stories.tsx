...
import type { TableCellRenderer, TableColumnSchema } from "../components/table";
import type {
...
const COLUMNS: TableColumnSchema<StockWatchlistItem>[] = [
    ...
    },
    {
        alignment: "end",
        allowsSorting: true,
        className: "border-l border-l-gray-200 tabular-nums",
        id: "price_high",
        maxWidth: 100,
        minWidth: 100,
        textValue: "High",
    ...
    },
    {
        alignment: "end",
        allowsSorting: true,
        className: "border-r border-r-gray-200 tabular-nums",
        id: "price_close",
        maxWidth: 100,
        minWidth: 100,
        textValue: "Close",
...
function Template({
    ...
    const { setSortDescriptor, sortDescriptor, sortedItems } = useSortedItems(
        data?.items ?? [],
    );
