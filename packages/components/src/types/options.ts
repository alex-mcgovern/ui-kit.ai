...
export type OptionsSchema<
    ...
    TItemId extends string = string,
    TValue extends object = object,
> = OptionsItemSchema<TType, TItemId, TValue> | OptionsSectionSchema<TType, TItemId, TValue>
...
interface OptionSchemaBase<TType extends OptionType, TItemId extends string = string> {
    children?: ReactNode
    description?: string
    href?: string
    icon?: ReactNode
