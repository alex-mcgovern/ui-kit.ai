...
type ListBoxProps<T extends OptionsSchema<'listbox'> = OptionsSchema<'listbox'>> = Omit<
    AriaListBoxProps<T>,
 ...
 */
export function ListBox<T extends OptionsSchema<'listbox'> = OptionsSchema<'listbox'>>({
