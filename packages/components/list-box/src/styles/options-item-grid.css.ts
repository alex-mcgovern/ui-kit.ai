...
export const optionItemGridLeftStyle = style({
...
export const optionItemGridRightStyle = style({
...
export const optionItemGridStyle = style({
    alignItems: "center",
    display: "grid",
    gridTemplateColumns: GRID_TEMPLATE_COLUMNS,
    selectors: {
        [`:has(${optionItemGridLeftStyle}:not(:empty)) &`]: {
            vars: {
                [LEFT_MARGIN]: SLOT_GAP,
                [LEFT_WIDTH]: SLOT_SIZE,
            },
        },
        [`:has(${optionItemGridRightStyle}:not(:empty)) &`]: {
            vars: {
